...
function loadStatsPage(){
	...
	for (row_counter = 2; row_counter < table.rows.length; row_counter++){
		for (col_counter = 2; col_counter < table.rows[row_counter].cells.length; col_counter++){
			if (col_counter == 3){
				n1 = table.rows[row_counter].cells[col_counter-1].innerHTML;
				n2 = table.rows[row_counter].cells[col_counter].innerHTML;
				if (n1 > n2){
...
function loadPlayersPage(){
	...
	for (var i = 0; i < players.length; i++){
		...
		input += "<a href = '#' class = 'dropdown-item' onclick = 'switchPlayers("+ i +")'>"+playername+"</a>"
	}
